# Generates market detail pages for SGA ENGINEERS redesign
$ErrorActionPreference = "Stop"
$root = Split-Path (Split-Path $PSScriptRoot -Parent) -Parent
# Script lives in sgaengineers-website/js - site root is parent of js
$site = Split-Path $PSScriptRoot -Parent
$outDir = Join-Path $site "markets"
...
$markets = @(
  @{
    ...
    imageAlt = "Healthcare facility exterior"
    introTitle = "Clinical environments. Constructible systems."
    intro = @(
    ...
    servicesTitle = "What we do in healthcare"
    services = @(
    ...
    outcomesTitle = "How owners and architects benefit"
    outcomes = @(
      @{ h = "Code-aware documentation"; p = "Designs that anticipate AHJ review, FGI-informed expectations, and the documentation density healthcare projects require." }
      @{ h = "Renovation that respects operations"; p = "Phasing, temporary measures, and constructability so care delivery is not an afterthought to engineering." }
      @{ h = "Systems that operate as designed"; p = "BCxP-informed commissioning pathways that verify critical environments perform at turnover - not only on paper." }
    )
  ...
  @{
    ...
    imageAlt = "Industrial facility infrastructure"
    introTitle = "Process-aware building systems"
    intro = @(
    ...
    servicesTitle = "What we do in industrial"
    services = @(
    ...
    outcomesTitle = "How owners and partners benefit"
    outcomes = @(
      @{ h = "Designs operators can live with"; p = "Serviceability, sequencing, and maintainability baked into the documents - not left for the field to invent." }
      @{ h = "Cross-pollination from food & mission-critical"; p = "Lessons from high-reliability and process markets improve redundancy thinking and utility resilience." }
      @{ h = "Partner-ready delivery"; p = "Design-bid-build, design-assist, and design-build support aligned to how industrial projects actually procure work." }
    )
  ...
  @{
    ...
    nav = "Zoos & Aquariums"
    meta = "MEP engineering for zoos and aquariums - life support interfaces, specialty environments, public buildings, and resilient utility systems."
    ...
    imageAlt = "Aquarium and aquatic environment"
    introTitle = "Unique buildings, integrated engineering"
    intro = @(
      "Zoo and aquarium projects demand careful coordination of water, air, power reliability, and life-safety with exhibit and operations teams."
      "We bring full-discipline MEPFT capability, constructible documentation, and the humility to coordinate closely with life-support specialists, architects, and facility staff who know these buildings best."
    )
    servicesTitle = "What we do for zoos & aquariums"
    services = @(
    ...
    outcomesTitle = "How teams benefit"
    outcomes = @(
      @{ h = "Coordinated, not siloed"; p = "MEPFT under one roof reduces interface gaps between building systems and specialty exhibit requirements." }
      @{ h = "Operations-first thinking"; p = "Designs that consider how staff maintain systems around animal care and public hours." }
      @{ h = "Trusted partner stance"; p = "Clear communication with owners, architects, and specialty consultants throughout design and CA." }
    )
  ...
  @{
    ...
    nav = "K-12 Education"
    meta = "K-12 school MEP engineering - HVAC, power, plumbing, fire, technology, and commissioning for classrooms, gyms, and campus renovations."
    ...
    introTitle = "Schools that perform for students and staff"
    intro = @(
    ...
    servicesTitle = "What we do for K-12"
    services = @(
    ...
    outcomesTitle = "How districts and architects benefit"
    outcomes = @(
      @{ h = "Budget-aware engineering"; p = "Right-sized systems and clear scopes that support competitive bidding and long-term O&M." }
      @{ h = "Renovation literacy"; p = "Phasing strategies that protect occupied campuses during upgrades." }
      @{ h = "Technology-ready buildings"; p = "Infrastructure that supports security, connectivity, and evolving classroom tools." }
    )
  ...
  @{
    ...
    imageAlt = "Professional project planning and documentation"
    introTitle = "Standards-driven delivery"
    intro = @(
    ...
    servicesTitle = "What we do for DoD & federal facilities"
    services = @(
    ...
    outcomesTitle = "How clients benefit"
    outcomes = @(
      @{ h = "Documentation discipline"; p = "Clear packages that stand up to review cycles and contractor scrutiny." }
      @{ h = "Continuity of staff"; p = "The team you meet remains accountable through design and CA." }
      @{ h = "Cross-market readiness"; p = "Experience across technical training, healthcare-adjacent, and industrial-type facilities strengthens DoD delivery." }
    )
  ...
  @{
    ...
    introTitle = "Commissioning with design fluency"
    intro = @(
    ...
    servicesTitle = "What we do in commissioning"
    services = @(
    ...
    outcomesTitle = "How owners benefit"
    outcomes = @(
      @{ h = "Risk reduction at turnover"; p = "Catch integration issues before they become warranty noise and occupant complaints." }
      @{ h = "Credentialed leadership"; p = "BCxP (ASHRAE) informs process quality and industry-aligned methods." }
      @{ h = "Design + Cx synergy"; p = "Whether we designed the systems or commission another team's work, we speak fluent MEPFT." }
    )
  ...
  @{
    ...
    imageAlt = "Hospitality and hotel environment"
    introTitle = "Front-of-house feel, back-of-house rigor"
    intro = @(
    ...
    servicesTitle = "What we do in hospitality"
    services = @(
    ...
    outcomesTitle = "How owners benefit"
    outcomes = @(
      @{ h = "Comfort that holds under load"; p = "Systems designed for real occupancy peaks - not brochure conditions only." }
      @{ h = "Serviceable BOH"; p = "Equipment locations and clearances that keep maintenance off the guest path." }
      @{ h = "Integrated low-voltage"; p = "Security and communications planned with power and life-safety - not added late." }
    )
  ...
  @{
    ...
    meta = "Food manufacturing MEP engineering - process utilities, hygiene-aware environments, ammonia plants, and reliable production infrastructure."
    ...
    image = "https://images.unsplash.com/photo-1565793298595-6a879b1d9492?auto=format&fit=crop&w=1600&q=80"
    imageAlt = "Manufacturing and production facility"
    introTitle = "Process-informed building engineering"
    intro = @(
    ...
    servicesTitle = "What we do in food manufacturing"
    services = @(
    ...
    outcomesTitle = "How processors benefit"
    outcomes = @(
      @{ h = "Utility reliability"; p = "Infrastructure planned around production criticality and maintainability." }
      @{ h = "Safety-aware electrical"; p = "Studies and designs that support safer operations around industrial power." }
      @{ h = "Field-informed details"; p = "Installation experience shows up in clearances, sequencing, and realistic details." }
    )
  ...
  @{
    ...
    imageAlt = "Civic and public architecture"
    introTitle = "Stewardship-minded engineering"
    intro = @(
    ...
    servicesTitle = "What we do for municipal clients"
    services = @(
    ...
    outcomesTitle = "How municipalities benefit"
    outcomes = @(
      @{ h = "Bid-ready documents"; p = "Clear scopes that support fair public bidding and fewer RFIs born of ambiguity." }
      @{ h = "Maintainable systems"; p = "Equipment choices and layouts public facility staff can support." }
      @{ h = "Capital clarity"; p = "Assessments and designs that help leaders sequence investments wisely." }
    )
  ...
  @{
    ...
    introTitle = "Core and shell to fit-out - done with precision"
    intro = @(
    ...
    servicesTitle = "What we do in corporate commercial"
    services = @(
    ...
    outcomesTitle = "How owners and tenants benefit"
    outcomes = @(
      @{ h = "Flexible infrastructure"; p = "Pathways and capacities planned for change without constant gut-and-replace." }
      @{ h = "Comfort + efficiency"; p = "Systems tuned for real workplace loads and energy goals." }
      @{ h = "Cleaner coordination"; p = "BIM-capable design that reduces trade conflicts before they hit the field." }
    )
  ...
  @{
    ...
    imageAlt = "Technology and automation systems"
    introTitle = "From sequences to systems that run"
    intro = @(
    ...
    servicesTitle = "What we do in automation"
    services = @(
    ...
    outcomesTitle = "How clients benefit"
    outcomes = @(
      @{ h = "Operable day one"; p = "Sequences and points lists that support meaningful functional tests." }
      @{ h = "Fewer orphan systems"; p = "MEP and technology coordinated so controls are not left to chance." }
      @{ h = "Optimization ready"; p = "Foundations for energy and performance improvement after occupancy." }
    )
  ...
  @{
    ...
    meta = "Water and wastewater facility MEP engineering - plant utilities, controls, power reliability, and support systems for treatment environments."
    hero = "Critical infrastructure engineering for water and wastewater facilities."
    lead = "Water and wastewater plants are 24/7 infrastructure. SGA supports mechanical, electrical, plumbing, fire, technology, and controls design for treatment and related facilities - where reliability, corrosive environments, and operational continuity shape every decision."
    image = "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=1600&q=80"
    imageAlt = "Industrial water infrastructure"
    introTitle = "Utility-class rigor"
    intro = @(
    ...
    servicesTitle = "What we do in water & wastewater"
    services = @(
    ...
    outcomesTitle = "How utilities benefit"
    outcomes = @(
      @{ h = "Uptime mindset"; p = "Designs that respect continuous operations and outage windows." }
      @{ h = "Harsh-environment practicality"; p = "Material and layout decisions informed by real plant conditions." }
      @{ h = "Clear interfaces"; p = "Coordination with process disciplines so building systems support treatment goals." }
    )
  ...
  @{
    ...
    imageAlt = "Data center and mission critical infrastructure"
    introTitle = "Redundancy with constructability"
    intro = @(
    ...
    servicesTitle = "What we do in mission critical"
    services = @(
    ...
    outcomesTitle = "How operators benefit"
    outcomes = @(
      @{ h = "Reliability by design"; p = "Topologies and capacities aligned to uptime goals and maintenance reality." }
      @{ h = "Integrated MEP + technology"; p = "Power, cooling, fire, and IT infrastructure coordinated early." }
      @{ h = "Verified performance"; p = "Cx pathways that test what matters before the facility goes live." }
    )
  ...
  @{
    ...
    title = "Retail"
    nav = "Retail"
    meta = "Retail MEP engineering for stores, mixed-use retail, and customer-facing facilities - fast schedules, brand standards, reliable systems."
    ...
    imageAlt = "Retail and commercial storefront environment"
    introTitle = "Fast, clean, operable"
    intro = @(
    ...
    servicesTitle = "What we do in retail"
    services = @(
    ...
    outcomesTitle = "How retailers benefit"
    outcomes = @(
      @{ h = "Schedule sensitivity"; p = "Responsive engineering that keeps pace with retail delivery." }
      @{ h = "Customer comfort"; p = "Thermal and IAQ strategies that support dwell time and staff performance." }
      @{ h = "Clean interfaces"; p = "Clear delineation with base building and other trades reduces field conflict." }
    )
  ...
  @{
    ...
    imageAlt = "Electric vehicle charging infrastructure"
    introTitle = "Power-first EV planning"
    intro = @(
    ...
    servicesTitle = "What we do for EV infrastructure"
    services = @(
    ...
    outcomesTitle = "How owners benefit"
    outcomes = @(
      @{ h = "No surprise capacity gaps"; p = "Studies that reveal constraints before equipment is ordered." }
      @{ h = "Expandable layouts"; p = "Designs that allow phased charger growth without rework chaos." }
      @{ h = "Code-compliant safety"; p = "Protection, grounding, and installation details that stand up to inspection." }
    )
  ...
  @{
    ...
    introTitle = "Campus complexity, clear engineering"
    intro = @(
    ...
    servicesTitle = "What we do in higher education"
    services = @(
    ...
    outcomesTitle = "How campuses benefit"
    outcomes = @(
      @{ h = "Program-ready systems"; p = "Engineering that matches pedagogy and research needs - not generic office HVAC with a new name." }
      @{ h = "Lifecycle value"; p = "Maintainable designs aligned with campus facilities operations." }
      @{ h = "Integrated low-voltage"; p = "Security, A/V, and data pathways planned with power and mechanical from the start." }
    )
  ...
  @{
    ...
    imageAlt = "Transportation and transit infrastructure"
    introTitle = "Operational buildings, public standards"
    intro = @(
    ...
    servicesTitle = "What we do in transportation"
    services = @(
    ...
    outcomesTitle = "How agencies and owners benefit"
    outcomes = @(
      @{ h = "Operations continuity"; p = "Phasing and system strategies that respect 24/7 transportation missions." }
      @{ h = "Public-ready life safety"; p = "Fire and egress systems engineered for assembly and transit use." }
      @{ h = "Future mobility readiness"; p = "Electrical planning that can grow with electrification." }
    )
  ...
  @{
    ...
    imageAlt = "Campground and outdoor hospitality setting"
    introTitle = "Rugged, simple, code-solid"
    intro = @(
    ...
    servicesTitle = "What we do for campgrounds"
    services = @(
    ...
    outcomesTitle = "How operators benefit"
    outcomes = @(
      @{ h = "Peak-season reliability"; p = "Systems planned for occupancy swings and outdoor conditions." }
      @{ h = "Maintainable simplicity"; p = "Designs park staff can understand and service." }
      @{ h = "Guest experience basics"; p = "Hot water, power, lighting, and comfort that just work." }
    )
  ...
  @{
    ...
    imageAlt = "Religious and community gathering architecture"
    introTitle = "Multi-use buildings, careful systems"
    intro = @(
    ...
    servicesTitle = "What we do for religious facilities"
    services = @(
      ...
      "Plumbing for restrooms, kitchens, and baptismal or specialty fixtures as applicable"
    ...
    outcomesTitle = "How congregations benefit"
    outcomes = @(
      @{ h = "Comfort during peak gatherings"; p = "Systems sized and zoned for real sanctuary and event loads." }
      @{ h = "Life-safety clarity"; p = "Assembly occupancy requirements addressed cleanly in design." }
      @{ h = "Stewardship"; p = "Durable, serviceable designs that protect long-term operating budgets." }
    )
  ...
  @{
    ...
    imageAlt = "Senior living and care environment"
    introTitle = "Care environments without institutional harshness"
    intro = @(
    ...
    servicesTitle = "What we do in assisted living"
    services = @(
    ...
    outcomesTitle = "How operators benefit"
    outcomes = @(
      @{ h = "Resident comfort & safety"; p = "Environmental systems and life safety that support quality of life." }
      @{ h = "Staff-efficient buildings"; p = "Technology and layouts that reduce friction in daily care operations." }
      @{ h = "Healthcare fluency"; p = "Lessons from clinical environments applied where care acuity is rising." }
    )
    related = @("healthcare", "hospitality", "commissioning")
  }
)

function Get-RelatedTitle($slug) {
  foreach ($m in $markets) {
    if ($m.slug -eq $slug) { return $m.title }
  }
  return $slug
}

function Render-Page($m) {
  $servicesHtml = ($m.services | ForEach-Object { "              <li>$_</li>" }) -join "`n"
  $introHtml = ($m.intro | ForEach-Object { "                <p>$_</p>" }) -join "`n"
  $outcomesHtml = ($m.outcomes | ForEach-Object {
    @"
...
"@
  ...
  $relatedHtml = ($m.related | ForEach-Object {
    $t = Get-RelatedTitle $_
    "            <a class=`"market-chip`" href=`"$_.html`">$t <svg viewBox=`"0 0 16 16`" fill=`"none`" aria-hidden=`"true`"><path d=`"M3 8h10M9 4l4 4-4 4`" stroke=`"currentColor`" stroke-width=`"1.5`"/></svg></a>"
  }) -join "`n"

  $allMarkets = ($markets | ForEach-Object {
    $active = if ($_.slug -eq $m.slug) { " is-active" } else { "" }
    "            <a class=`"market-chip$active`" href=`"$($_.slug).html`">$($_.nav)</a>"
  }) -join "`n"
        ...
        <div class="container">
          <div class="split reveal">
            <div class="split__body">
              ...
              <h2 class="section-title">$($m.introTitle)</h2>
              <div class="prose">
$introHtml
              </div>
            ...
            <div class="split__media split__media--wide">
              <img src="$($m.image)" alt="$($m.imageAlt)" width="1400" height="1120" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="section-head reveal">
            <div>
              ...
              <h2 class="section-title">$($m.servicesTitle)</h2>
              <p class="section-lead">
                Full-discipline mechanical, electrical, plumbing, fire, technology, and commissioning
                services tailored to $($m.title.ToLower()) project realities.
              </p>
            </div>
          </div>
          <ul class="capability-list reveal" style="grid-template-columns: repeat(2, minmax(0, 1fr)); max-width: 56rem">
$servicesHtml
          </ul>
        </div>
      </section>
        ...
        <div class="container">
          <div class="section-head reveal">
            <div>
              ...
              <h2 class="section-title">$($m.outcomesTitle)</h2>
            </div>
          </div>
...
$allMarkets
      ...
      <section class="cta-strip">
        <div class="container reveal">
          <div>
            <h2>Planning a $($m.title.ToLower()) project?</h2>
            <p>
...
foreach ($m in $markets) {
  $path = Join-Path $outDir "$($m.slug).html"
  $html = Render-Page $m
  [System.IO.File]::WriteAllText($path, $html, [System.Text.UTF8Encoding]::new($false))
  Write-Host "Wrote $($m.slug).html"
}

# Emit market list for parent page updates
$markets | ForEach-Object { "$($_.slug)|$($_.nav)" } | Set-Content (Join-Path $outDir "_list.txt")
Write-Host "Done. $($markets.Count) market pages."
